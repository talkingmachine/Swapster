  ...
  return (
    <div className="content-wrapper">
      <section className="page__content">
        ...
        <ContentPost/>
        <ContentPost/>
        <div className="content__pages-swithing">
          <button className="pages-swithing-button pages-swithing__prev-page pages-swithing-button--inactive">
            <svg width={15} height={15} viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="7.5" cy="7.5" r={7} stroke="#8287F3" /><path d="M6.42871 5.35742L8.83943 7.76814L6.42871 10.1789" stroke="#8287F3" /></svg>
            <span>Назад</span>
          </button>
          <ul className="pages-swithing__page-numbers">
            <li className="page-numbers__item page-numbers--current">1</li>
            <li className="page-numbers__item">2</li>
            <li className="page-numbers__item">3</li>
            <li className="page-numbers__item">4</li>
            <li className="page-numbers__item">...</li>
            <li className="page-numbers__item">35</li>
            <li className="page-numbers__item">36</li>
          </ul>
          <button className="pages-swithing-button pages-swithing__next-page">
            <span>Вперед</span>
            <svg width={15} height={15} viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="7.5" cy="7.5" r={7} stroke="#8287F3" /><path d="M6.42871 5.35742L8.83943 7.76814L6.42871 10.1789" stroke="#8287F3" /></svg>
          </button>
        </div>
